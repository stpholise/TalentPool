  ...
  return (
    <header    className="pageHeader " >
        <div className="smallScreenMenu menuBtn">
            <button className=" transBtn" onClick={() => dispatch(toggleGenMenu())}> <img src={Hamboger} alt="hamburger icon" className="wh-24"/></button>
            <div className="grouping2">
                ...
                <button title="ball container" className='profDis ballCont' onClick={() => toggleProfileMenu()}>
                    <img alt="ball" src={UserCircle} className={`ball ${profileMenu ? 'active' : ''} `} />
                    <img alt='ball' src={ExpandMore} className={`expan ${profileMenu ? 'active' : ''} `} />
                </button>
            </div>
        </div>

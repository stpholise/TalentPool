...
const Person = ({employer = false }: PersonProps) => {
  ...
  const handleUserUpdate = ( values: UserFormValues, actions: FormikHelpers<UserFormValues>) => {
  ...
  const profileModalToggle = () => {
    ...
    editProfileModal ? dispatch(modalIsClose()) : dispatch(modalIsOpen());
  }
                  ...
                  return(
                      <Form >
                        <p className="topFles spaceBet ">
                            ...
                            <button className="skillModalBtn btn"  onClick={() => {setEditProfileModal(false); dispatch(modalIsClose())} }><img src={Close} alt="close icon" /></button>
                          </p>
                          <Field 
                              name="name"
                              type="text" 
